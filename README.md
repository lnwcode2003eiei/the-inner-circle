...
ผู้นำเลือกผู้เล่นให้แต่ละอักษรที่ดิลต้องการ ผู้เล่นเดียวถือหลายอักษรได้ ผู้นำและผู้ถูกเลือกเป็นผู้ร่วมดิล ปุ่มเงินเริ่ม 0 → 1M → 1.5M → 2M เพิ่มครั้งละ 0.5M ไม่เกินมูลค่าดิล ต้องแบ่งครบและทุกคนยอมรับจึงจ่าย การเปลี่ยนผู้ร่วมดิล ข้อเสนอ หรือใช้การ์ดล้างการยอมรับเดิม
...
ยังไม่ได้เชื่อมบัญชี hosting หรือฐานข้อมูลจริงใน workspace นี้ ต้องตั้งค่าบริการข้างต้นก่อนเล่นผ่านอินเทอร์เน็ต ภาพการ์ดสร้างด้วย AI เก็บใน public/art; portraits จาก Unsplash ฟอนต์ Google Fonts โลโก้ SVG และเสียงสร้างสำหรับโปรเจกต์นี้
