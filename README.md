...
สุ่มลำดับผู้เล่นและผู้เริ่มต้นพร้อมแจก A–F: 3–6 คนแบ่งนักลงทุนหกตัวอย่างสมดุล; 7–12 คนได้คนละตัว ตัวอักษรซ้ำได้ไม่เกินสองตัวต่ออักษร เล่น 15 / 20 / 25 ดิลตามจำนวน 3–6 / 7–9 / 10–12 คน ดิลละ 120 วินาที
...
หน้าเกม กติกา การ์ด ข้อความแจ้งเตือน และบันทึกเหตุการณ์ใช้ภาษาไทย แสดงเงินในเกมเป็น 0$, 1$, 1.5$ โดยคงสัดส่วนค่าภายในเดิมและวันที่/เวลารูปแบบไทย ธีมใช้พื้นครีมกระดาษเก่า เมนูน้ำตาลไม้ แผงน้ำเงินหม่น ปุ่มแดงไวน์ และรายละเอียดทองเก่า ฟอนต์ Noto Sans Thai / Noto Serif Thai ชื่อแบรนด์ The Inner Circle และรหัสนักลงทุน A–F คงเดิม โดยรหัส Socket และกติกาไม่เปลี่ยน
